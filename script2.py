...
def main():
    ...
    for x in range(0, 85 + 1):
        ...
        for n5 in range(0, n5_max + 1):
            ...
            for n9 in range(10, H + 1):
                for n8 in range(10, H - n9 + 1):
                    for n7 in range(10, H - n9 - n8 + 1):
                        n6 = H - n9 - n8 - n7
                        if n6 < 0: continue
                        ...
                        for n1 in range(max(a, 0), L + 1):
                            ...
                            for n2 in range(n2_min, n2_max + 1):
                                ...
                                while n3 <= n3_max:
                                    ...
                                    if n1 >= 10 and n2 >= 10 and n3 >= 10 and n4 >= 10 and n5 >= 10 and n6 >= 10 and n7 >= 10 and n8 >= 10 and n9 >= 10:
                                        dictionary[total_count] = [n1, n2, n3, n4, n5, n6, n7, n8]
                                        total_count += 1
