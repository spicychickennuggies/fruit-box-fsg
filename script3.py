...
def main():
    ...
    for x in range(0, 85 + 1):
        ...
        for n5 in range(15, n5_max + 1):
            ...
            for n9 in range(15, H + 1):
                for n8 in range(15, H - n9 + 1):
                    for n7 in range(15, H - n9 - n8 + 1):
                        n6 = H - n9 - n8 - n7
                        if n6 < 0: continue
                        ...
                        for n1 in range(max(a, 0), L + 1):
                            ...
                            for n2 in range(n2_min, n2_max + 1):
                                ...
                                while n3 <= n3_max:
                                    ...
                                    if n1 >= 15 and n1 <= 30 and n2 >= 15 and n3 >= 15 and n4 >= 15 and n5 >= 15 and n6 >= 15 and n7 >= 15 and n8 >= 15 and n9 >= 15:
